...
namespace api::v1 {
    ...
    public:
        ...
        ADD_METHOD_TO(ProjectsController::remove, "/api/v1/project/{1:id}?token={2:token}", drogon::Delete, "AuthFilter");
    ...
    private:
        ...
        drogon::Task<std::optional<Project>>
        ProjectsController::validateProjectAccess(const std::string &id, const std::string &token,
                                                  std::function<void(const drogon::HttpResponsePtr &)> callback) const;
