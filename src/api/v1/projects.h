...
namespace api::v1 {
    class ProjectsController : public drogon::HttpController<ProjectsController, false> {
    public:
    ...
    public:
        ...
        drogon::Task<> create(drogon::HttpRequestPtr req, std::function<void(const drogon::HttpResponsePtr &)> callback, std::string token) const;
