...
class ProjectItem
{
  public:
     ...
     */
    explicit ProjectItem(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProjectItem(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProjectItem(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<ProjectItem>;
    friend drogon::orm::BaseBuilder<ProjectItem, true, true>;
    friend drogon::orm::BaseBuilder<ProjectItem, true, false>;
    friend drogon::orm::BaseBuilder<ProjectItem, false, true>;
    friend drogon::orm::BaseBuilder<ProjectItem, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProjectItem>;
#endif
