...
class Item
{
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Item, true, true>;
    friend drogon::orm::BaseBuilder<Item, true, false>;
    friend drogon::orm::BaseBuilder<Item, false, true>;
    friend drogon::orm::BaseBuilder<Item, false, false>;
#ifdef __cpp_impl_coroutine
