...
class AccessKey
{
  public:
     ...
     */
    explicit AccessKey(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AccessKey(const Json::Value &pJson) noexcept(false);
     ...
     */
    AccessKey(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<AccessKey>;
    friend drogon::orm::BaseBuilder<AccessKey, true, true>;
    friend drogon::orm::BaseBuilder<AccessKey, true, false>;
    friend drogon::orm::BaseBuilder<AccessKey, false, true>;
    friend drogon::orm::BaseBuilder<AccessKey, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<AccessKey>;
#endif
