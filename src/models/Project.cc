...
Project::Project(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        ...
        if(!r["modid"].isNull())
        {
            modid_=std::make_shared<std::string>(r["modid"].as<std::string>());
        }
        if(!r["is_virtual"].isNull())
        {
            isVirtual_=std::make_shared<bool>(r["is_virtual"].as<bool>());
        }
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            modid_=std::make_shared<std::string>(r[index].as<std::string>());
        }
        index = offset + 12;
        if(!r[index].isNull())
        {
            isVirtual_=std::make_shared<bool>(r[index].as<bool>());
        }
        index = offset + 13;
        if(!r[index].isNull())
        {
...
Project::Project(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[11].empty() && pJson.isMember(pMasqueradingVector[11]))
    {
        ...
        {
            modid_=std::make_shared<std::string>(pJson[pMasqueradingVector[11]].asString());
        }
    }
    if(!pMasqueradingVector[12].empty() && pJson.isMember(pMasqueradingVector[12]))
    {
        ...
        {
            isVirtual_=std::make_shared<bool>(pJson[pMasqueradingVector[12]].asBool());
        }
    }
...
Project::Project(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("modid"))
    {
        dirtyFlag_[11]=true;
        if(!pJson["modid"].isNull())
        {
            modid_=std::make_shared<std::string>(pJson["modid"].asString());
        }
    }
    if(pJson.isMember("is_virtual"))
    {
        dirtyFlag_[12]=true;
        if(!pJson["is_virtual"].isNull())
        {
            isVirtual_=std::make_shared<bool>(pJson["is_virtual"].asBool());
        }
    }
...
const std::string &Project::getValueOfModid() const noexcept
{
    static const std::string defaultValue = std::string();
    if(modid_)
        return *modid_;
...
const std::shared_ptr<std::string> &Project::getModid() const noexcept
{
    return modid_;
}
void Project::setModid(const std::string &pModid) noexcept
{
    modid_ = std::make_shared<std::string>(pModid);
    dirtyFlag_[11] = true;
}
void Project::setModid(std::string &&pModid) noexcept
{
...
const bool &Project::getValueOfIsVirtual() const noexcept
{
    static const bool defaultValue = bool();
    if(isVirtual_)
        return *isVirtual_;
...
const std::shared_ptr<bool> &Project::getIsVirtual() const noexcept
{
    return isVirtual_;
}
void Project::setIsVirtual(const bool &pIsVirtual) noexcept
{
    isVirtual_ = std::make_shared<bool>(pIsVirtual);
    dirtyFlag_[12] = true;
}

const std::string &Project::getValueOfVisibility() const noexcept
{
    static const std::string defaultValue = std::string();
    if(visibility_)
        return *visibility_;
...
const std::shared_ptr<std::string> &Project::getVisibility() const noexcept
{
    return visibility_;
}
void Project::setVisibility(const std::string &pVisibility) noexcept
{
    visibility_ = std::make_shared<std::string>(pVisibility);
    dirtyFlag_[13] = true;
}
void Project::setVisibility(std::string &&pVisibility) noexcept
{
...
Json::Value Project::toJson() const
{
    ...
    if(getModid())
    {
        ret["modid"]=getValueOfModid();
    }
    else
    {
        ret["modid"]=Json::Value();
    }
    if(getIsVirtual())
    {
        ret["is_virtual"]=getValueOfIsVirtual();
    }
    else
    {
        ret["is_virtual"]=Json::Value();
    }
    if(getVisibility())
    {
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 15)
    {
        ...
        if(!pMasqueradingVector[11].empty())
        {
            if(getModid())
            {
                ret[pMasqueradingVector[11]]=getValueOfModid();
            }
            else
            {
        ...
        if(!pMasqueradingVector[12].empty())
        {
            if(getIsVirtual())
            {
                ret[pMasqueradingVector[12]]=getValueOfIsVirtual();
            }
            else
            {
        ...
        if(!pMasqueradingVector[13].empty())
        {
            if(getVisibility())
            {
                ret[pMasqueradingVector[13]]=getValueOfVisibility();
            }
            else
            {
...
bool Project::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("is_virtual"))
    {
        if(!validJsonOfField(12, "is_virtual", pJson["is_virtual"], err, true))
            return false;
    }
    if(pJson.isMember("visibility"))
    {
...
bool Project::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("modid"))
    {
        if(!validJsonOfField(11, "modid", pJson["modid"], err, false))
            return false;
    }
    if(pJson.isMember("is_virtual"))
    {
        if(!validJsonOfField(12, "is_virtual", pJson["is_virtual"], err, false))
            return false;
    }
    if(pJson.isMember("visibility"))
    {
