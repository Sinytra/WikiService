...
class Recipe
{
  public:
     ...
     */
    explicit Recipe(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Recipe(const Json::Value &pJson) noexcept(false);
     ...
     */
    Recipe(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Recipe>;
    friend drogon::orm::BaseBuilder<Recipe, true, true>;
    friend drogon::orm::BaseBuilder<Recipe, true, false>;
    friend drogon::orm::BaseBuilder<Recipe, false, true>;
    friend drogon::orm::BaseBuilder<Recipe, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Recipe>;
#endif
