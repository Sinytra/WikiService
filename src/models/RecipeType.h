...
class RecipeType
{
  public:
     ...
     */
    explicit RecipeType(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit RecipeType(const Json::Value &pJson) noexcept(false);
     ...
     */
    RecipeType(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<RecipeType>;
    friend drogon::orm::BaseBuilder<RecipeType, true, true>;
    friend drogon::orm::BaseBuilder<RecipeType, true, false>;
    friend drogon::orm::BaseBuilder<RecipeType, false, true>;
    friend drogon::orm::BaseBuilder<RecipeType, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<RecipeType>;
#endif
