...
class UserProject
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,std::string>;//user_id,project_id
     ...
     */
    explicit UserProject(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserProject(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserProject(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<UserProject>;
    friend drogon::orm::BaseBuilder<UserProject, true, true>;
    friend drogon::orm::BaseBuilder<UserProject, true, false>;
    friend drogon::orm::BaseBuilder<UserProject, false, true>;
    friend drogon::orm::BaseBuilder<UserProject, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserProject>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where user_id = $1 and project_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where user_id = $1 and project_id = $2";
        return sql;
    }
