...
class Report
{
  public:
    struct Cols
    {
        ...
        static const std::string _reason;
        static const std::string _body;
        static const std::string _status;
        static const std::string _submitter_id;
     ...
     */
    explicit Report(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Report(const Json::Value &pJson) noexcept(false);
     ...
     */
    Report(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column reason  */
    ///Get the value of the column reason, returns the default value if the column is null
    const std::string &getValueOfReason() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getReason() const noexcept;
    ///Set the value of the column reason
    void setReason(const std::string &pReason) noexcept;
    void setReason(std::string &&pReason) noexcept;
    ...
    /**  For column submitter_id  */
    ///Get the value of the column submitter_id, returns the default value if the column is null
    const std::string &getValueOfSubmitterId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getSubmitterId() const noexcept;
    ///Set the value of the column submitter_id
    void setSubmitterId(const std::string &pSubmitterId) noexcept;
    void setSubmitterId(std::string &&pSubmitterId) noexcept;
    ...
    const std::string &getValueOfLocale() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getLocale() const noexcept;
    ///Set the value of the column locale
    void setLocale(const std::string &pLocale) noexcept;
    void setLocale(std::string &&pLocale) noexcept;
    void setLocaleToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Report>;
    friend drogon::orm::BaseBuilder<Report, true, true>;
    friend drogon::orm::BaseBuilder<Report, true, false>;
    friend drogon::orm::BaseBuilder<Report, false, true>;
    friend drogon::orm::BaseBuilder<Report, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Report>;
#endif
    ...
    std::shared_ptr<std::string> reason_;
    std::shared_ptr<std::string> body_;
    std::shared_ptr<std::string> status_;
    std::shared_ptr<std::string> submitterId_;
