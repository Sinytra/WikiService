...
class Deployment
{
  public:
     ...
     */
    explicit Deployment(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Deployment(const Json::Value &pJson) noexcept(false);
     ...
     */
    Deployment(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void setRevisionToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Deployment>;
    friend drogon::orm::BaseBuilder<Deployment, true, true>;
    friend drogon::orm::BaseBuilder<Deployment, true, false>;
    friend drogon::orm::BaseBuilder<Deployment, false, true>;
    friend drogon::orm::BaseBuilder<Deployment, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Deployment>;
#endif
