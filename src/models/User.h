...
class User
{
  public:
    ...
    /**  For column modrinth_id  */
    ///Get the value of the column modrinth_id, returns the default value if the column is null
    const std::string &getValueOfModrinthId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getModrinthId() const noexcept;
    ///Set the value of the column modrinth_id
    void setModrinthId(const std::string &pModrinthId) noexcept;
    void setModrinthId(std::string &&pModrinthId) noexcept;
    void setModrinthIdToNull() noexcept;
    ...
    std::vector<std::pair<Project,UserProject>> getProjects(const drogon::orm::DbClientPtr &clientPtr) const;
