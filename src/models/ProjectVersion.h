...
class ProjectVersion
{
  public:
     ...
     */
    explicit ProjectVersion(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProjectVersion(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProjectVersion(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<ProjectVersion>;
    friend drogon::orm::BaseBuilder<ProjectVersion, true, true>;
    friend drogon::orm::BaseBuilder<ProjectVersion, true, false>;
    friend drogon::orm::BaseBuilder<ProjectVersion, false, true>;
    friend drogon::orm::BaseBuilder<ProjectVersion, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProjectVersion>;
#endif
